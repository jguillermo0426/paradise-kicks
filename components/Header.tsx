...
export default function Header({navSelected}: SelectedProps) {
    ...
    const selected = "group mx-5 transition-colors flex items-center justify-center w-[9rem] pt-20 pb-3 px-5 border-2 border-solid rounded-b-[0.625rem] border-[#177F7D] -mt-16 hover:bg-[#F0F0F0] hover:cursor-pointer";
    ...
    const selectedTextToggle = 'font-semibold transition-colors text-[#177F7D] text-xl';
    const unselectedTextToggle = 'font-semibold transition-colors text-black group-hover:text-white text-xl'
    ...
    return(
        <main className="z-50 shadow-lg sticky top-0 flex flex-col w-full min-[769px]:h-[6rem] justify-between items-center">
            <div className="flex flex-row bg-white w-full h-auto justify-between items-between px-10">
                <div className='max-[768px]:hidden ml-10 flex flex-col justify-center items-center'>
                    <Link href="/">
                        <UnstyledButton>
                        <Image
                            src="/blue logo.png"
                ...
                <div className='max-[768px]:hidden flex flex-row items-center justify-center'>
                ...
                <div className="min-[769px]:hidden flex flex-col w-full">
                    <div className="flex flex-row justify-between">
                        <button className="flex flex-row items-left w-[48px] h-[48px] mt-5" onClick={toggleNavbar}>
                            { !isOpen ? (
                        ...
                        <div className='min-[769px]:hidden mt-1 justify-center items-center'>
                            <Link href="/">
                                <UnstyledButton>
                                <Image
                                    src="/blue logo.png"
                        ...
                        <Link href="/cart">
                            <div className="max-[768px]:mr-0 mr-10 flex flex-row items-center justify-end pt-20 pb-3 border-2 border-none -mt-12 ">
                ...
                {/* CART */}
                <Link href="/cart">
                    <div className="max-[768px]:hidden max-[768px]:mr-0 mr-10 flex flex-row items-center justify-end pt-20 pb-3 border-2 border-none -mt-12 ">
                        <Badge size="sm" color="#2E7D31" circle 
                        className="z-10"
                        styles={{ 
                            root: { 
