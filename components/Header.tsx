...
export default function Header({navSelected}: SelectedProps) {
    ...
    return(
        <main className="z-50 shadow-lg sticky top-0 flex flex-col w-full min-[769px]:h-full justify-between items-center">
            <div className="flex flex-row bg-white w-full h-auto justify-between items-between px-10">
                <div className='max-[912px]:w-[90px] max-[912px]:h-[90px] max-[769px]:hidden ml-10 flex flex-col justify-center items-center'>
                    <Link href="/">
                        <UnstyledButton>
                        <Image
                            src="/blue logo.png"
                ...
                <div className='max-[769px]:hidden flex flex-row items-center justify-center'>
                ...
                <div className="min-[769px]:hidden flex flex-col w-full">
                    <div className="flex flex-row justify-between">
                        <button className="flex flex-row items-left max-[420px]:mt-7 max-[420px]:w-[38px] max-[420px]:h-[38px] w-[48px] h-[48px] mt-5" onClick={toggleNavbar}>
                            { !isOpen ? (
                        ...
                        <div className='min-[769px]:hidden mt-3 mr-5 justify-center items-center'>
                            <Link href="/">
                                <UnstyledButton>
                                <Image
                                    src="/blue logo.png"
                        ...
                        <Link href="/cart">
                            <div className="-mt-[3.2rem] max-[769px]:pb-5 mr-10 flex flex-row items-center justify-end pt-20 pb-3 border-2 border-none -mt-12 max-[912px]:mr-0">
                ...
                {/* CART */}
                <Link href="/cart">
                    <div className="max-[769px]:hidden max-[768px]:mr-0 mr-8 flex flex-row items-center justify-end pt-20 pb-3 border-2 border-none -mt-12 max-[912px]:px-5">
                        <Badge size="sm" color="#2E7D31" circle 
                        className="z-10"
                        styles={{ 
                            root: { 
                        ...
                        <p style={epilogue.style} className='font-semibold text-black max-[1024px]:text-sm max-[912px]:hidden text-xl ml-6'>My Cart</p>
                    </div>
                </Link>
            </div>    
