...
export default function Cart() {
    ...
    useEffect(() => {
        const getCartItems = async () => {
            let fetchedItems: itemOrder[] = [];
            let item: Product;
            
            await Promise.all(cart.map(async (cartItem) => {
                const response = await fetch(`/api/product/get_item?sku=${cartItem.sku}`, {
                    method: "GET"
                });
                ...
                <div className="flex flex-col items-center justify-center w-full max-w-[1440px] m-6">
                    ...
                    <div className="w-full flex flex-col items-start justify-start mb-10">
                        ...
                        <div className="w-full flex flex-row items-start justify-start mt-10">
                                    ...
                                    <div key={itemIndex} className="flex flex-row w-full min-w-[650px] max-w-[720px] h-[228px] items-center justify-start mb-8 p-6 border-[#474747] border-2 rounded-xl">
                                        ...
                                        <div className="flex flex-col justify-start">
                                            ...
                                            <div className="flex flex-row items-center justify-between w-[100px] h-[30px] bg-[#1C1C1C] rounded-md">
                                                <ActionIcon  variant="filled" color="#474747" size={30} aria-label="minus">
                                                ...
                                                <ActionIcon variant="filled" color="#474747" size={30} aria-label="add">
                            ...
                            <div className="w-full flex flex-col basis-2/5 min-w-[493px] min-h-[558px] max-h-[558px] justify-start items-center border-[#474747] border-2 rounded-xl">
                                <p>Order Summary</p>
                            </div> 
                        </div>
                    </div>
